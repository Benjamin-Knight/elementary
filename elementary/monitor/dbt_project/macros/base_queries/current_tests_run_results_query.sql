    ...
    test_results as (
        select
            ...
            case
                ...
                else coalesce(elementary_test_results.test_unique_id, 'None') {{ elementary.string_join() }} '.' {{ elementary.string_join() }} coalesce(elementary_test_results.column_name, 'None') {{ elementary.string_join() }} '.' {{ elementary.string_join() }} coalesce(elementary_test_results.test_sub_type, 'None')
